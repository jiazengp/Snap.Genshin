...
namespace DGP.Genshin.Helper
{
    ...
    {
        public static Visibility GetArrowVisibility(Expander item) => (Visibility)item.GetValue(ArrowVisibilityProperty);

        public static void SetArrowVisibility(Expander item, Visibility value) => item.SetValue(ArrowVisibilityProperty, value);
