...
namespace DGP.Genshin.Controls.Html
{
    internal static class HtmlCssParser
    {
        ...
        private static readonly string[] _blocks = { "block", "inline", "list-item", "none" };
        // .................................................................
        //
        ...
        {
            while (nextIndex < styleValue.Length && System.Char.IsWhiteSpace(styleValue[nextIndex]))
            {
                nextIndex++;
            }
        }
        ...
        private static bool ParseWord(string word, string styleValue, ref int nextIndex)
        {
            ...
            if (nextIndex + word.Length < styleValue.Length && System.Char.IsLetterOrDigit(styleValue[nextIndex + word.Length]))
            {
                return false;
            }
        ...
        private static string ParseCssSize(string styleValue, ref int nextIndex, bool mustBeNonNegative)
        {
            ...
            if (nextIndex < styleValue.Length && System.Char.IsDigit(styleValue[nextIndex]))
            {
                while (nextIndex < styleValue.Length &&
                       (System.Char.IsDigit(styleValue[nextIndex]) || styleValue[nextIndex] == '.'))
                {
                    nextIndex++;
                }
                ...
                string unit = ParseWordEnumeration(FontSizeUnits, styleValue, ref nextIndex) ?? "px";
        ...
        private static string ParseCssColor(string styleValue, ref int nextIndex)
        {
            ...
            if (nextIndex < styleValue.Length)
            {
                ...
                if (character == '#')
                {
                    ...
                    while (nextIndex < styleValue.Length)
                    {
                        character = System.Char.ToUpper(styleValue[nextIndex]);
                ...
                else if (System.Char.IsLetter(character))
                {
            ...
            string propertyName)
        {
            ...
            string value = propertyName == "border-color"
