...
namespace DGP.Genshin.Controls.Html
{
    ...
    ///     <para>Simpily use <see cref="ConvertHtmlToXaml"/> to convert html</para>
    /// </summary>
    public static class HtmlToXamlConverter
    {
            ...
            Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            XmlElement xamlTableColumnElement = xamlTableColumnGroupElement.OwnerDocument.CreateElement(null, XamlTableColumn,
                XamlNamespace);
            ...
            out Hashtable localProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            switch (elementName)
            {
                ...
                case "font":
                    ...
                    {
                        localProperties["font-family"] = "Microsoft YaHei UI"/*attributeValue*/;
                    }
                    ...
                    break;
                case "samp":
                    localProperties["font-family"] = "MicroSoft YaHei UI"; // code sample
                ...
                case "div":
                    ...
                    break;
                case "pre":
                    localProperties["font-family"] = "Microsoft YaHei UI"; // renders text in a fixed-width font
                    localProperties["font-size"] = XamlFontSizeXxSmall;
                    localProperties["text-align"] = "Left";
                    break;
                case "blockquote":
