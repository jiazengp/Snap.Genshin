...
namespace DGP.Genshin.Controls.Html
{
    internal class CssStylesheet
    {
        ...
        public void AddStyleDefinition(string selector, string definition)
        {
            ...
            {
                this._styleDefinitions = new List<StyleDefinition>();
            }
            ...
            {
                string simpleSelector = t.Trim();
                if (simpleSelector.Length > 0)
                {
                    this._styleDefinitions.Add(new StyleDefinition(simpleSelector, definition));
                }
            }
        }
        ...
        public string GetStyle(string elementName, List<XmlElement> sourceContext)
        {
            ...
            if (this._styleDefinitions != null)
            {
                ...
                {
                    string selector = this._styleDefinitions[i].Selector;
