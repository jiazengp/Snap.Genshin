...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(SnapGenshinAnalyzerCodeFixProvider)), Shared]
    public class SnapGenshinAnalyzerCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get => ImmutableArray.Create(SGAPI0001MethodUnstableAnalyzer.Id);
        }
